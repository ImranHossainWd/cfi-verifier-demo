...
from arithmetic_rules import run_arithmetic_rules
...
def run_subpacket_checks(sp: SubPacket, config: Config,
    ...
    # 12 + 13. Arithmetic reconciliation rules (Pull Ticket allocation sum,
    # Extra Cases USED case-count sum). Defined in arithmetic_rules.py so
    # they can be unit-tested in isolation.
    run_arithmetic_rules(sp, CheckResult, rules_cfg)
...
def verify_pdf(pdf_path: str, out_dir: str,
               ...
               vision_force: bool = False) -> PacketReport:
    pdf_p = Path(pdf_path)
